...
fetch("https://api.openweathermap.org/data/2.5/forecast?id=524901&appid={API key}"+ cityName+ "&appid"+APIKey)
...
fetch("https://api.openweathermap.org/data/2.5/forecast?id=524901&appid={API key}"+lat+"&lon="+lon+"&appid="+APIKey+"&cnt=1")
.then(function(response){
...
fetch("https://api.openweathermap.org/data/2.5/forecast?id=524901&appid={API key}"+getCity+"&appid="+APIKey)
.then(function(response){
    console.log(response);
